...
function showNextProblem() {
	...
	while (previousProblem === currentProblem) {
		switch (selectedCategory) {
			...
			case 'builtin-division':
				...
				problemText = currentProblem.firstNumber + ' / ' + currentProblem.secondNumber;
				break;
			case 'builtin-nonword':
				currentProblem = getQuestionFromList(samples.nonword);
				problemText = currentProblem.key;
				break;
			case 'builtin-colorword':
				currentProblem = getQuestionFromList(samples.colorword);
				problemText = currentProblem.key;
				break;
	...
	document.getElementsByClassName('problem')[0].style.color = currentProblem.value;
}
